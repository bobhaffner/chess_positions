...
def main(player_name, goof_threshold, stockfish_path, card_images_path):

    game = get_latest_chess_com_game(player_name)
    ...
    for goof in sorted_goofs:
        ...
        front_img_name = f"{run_id}_{goof['move_num']}_front.jpg"
        ...
        back_img_name = f"{run_id}_{goof['move_num']}_back.jpg"
    ...
    with open(f'{run_id}_flash_cards.csv', 'w', newline='') as f:
        writer = csv.writer(f)
...
if __name__ == '__main__':
    ...
    main(args.player_name, args.goof_threshold, args.stockfish_path, args.card_images_path)